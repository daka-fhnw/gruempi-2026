...
export default function Sponsoren() {
  ...
  if (sponsoren !== null) {
    return (
      <div className="mb-n3">
        <h1>Sponsoren</h1>
        {sponsoren.triangulationspunkte.length > 0 && (
          <>
        ...
        {sponsoren.hoehenfixpunkte.length > 0 && (
          <>
            <h2>Höhenfixpunkt</h2>
            <SponsorGruppe
        ...
        {sponsoren.grenzpunkte.length > 0 && (
          <>
            <h2>Grenzpunkt</h2>
